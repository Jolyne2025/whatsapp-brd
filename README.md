# WhatsApp 买家侧 BRD / PRD

## BRD：WhatsApp 买家发送策略（一期）

- 在线浏览：[BRD index.html](index.html)
- 源文档：[BRD_WhatsApp买家发送策略一期.md](BRD_WhatsApp买家发送策略一期.md)

## PRD：WhatsApp 买家营销消息 · 订阅点位设计（v0.2）
